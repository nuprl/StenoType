...
def _summarize_example(example: dict[str, Any]) -> dict[str, Any]:
    ...
    pct_errors = num_errors / num_completions
    ...
    example["num_errors"] = num_errors
    example["num_type_checks"] = num_type_checks
    example["pct_errors"] = pct_errors
...
def _summarize_dataset(
    ...
    # TODO: might need to filter out results with errors
    ...
    total_errors = np.sum(dataset["num_errors"])
